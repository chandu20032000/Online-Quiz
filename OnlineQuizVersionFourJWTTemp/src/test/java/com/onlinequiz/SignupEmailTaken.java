...
public class SignupEmailTaken {
	 @Autowired
	  ...
	  @Test
		  ...
		  void signupUser() throws Exception
			{
				SignupRequest signupRequest=new SignupRequest("nikki", "nikki@gmail.com", "Student", "saichand.", "SDPT","1234567891");
	...
	void signupEmailTaken() throws Exception
	{
      ...
      void deleteUser() throws Exception{
          ...
          LoginRequest loginRequest=new LoginRequest("nikki","saichand.");
 		  ...
 		  MvcResult resultdelete= mockMvc.perform(delete("/user?id="+"nikki", 42L)
